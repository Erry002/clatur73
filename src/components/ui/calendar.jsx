  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_today: " bg-olive/20 text-accent-foreground",
        day_outside:
          "day-outside text-muted-foreground opacity-100 aria-selected:bg-accent/100 aria-selected:text-muted-foreground aria-selected:opacity-80",
