...
export default function footer() {
  return (
    <>
      ...
      />
      <footer className="w-full bg-grigio sm:flex sm:justify-center sm:items-center">
        <div className=" flex flex-col max-w-4xl w-full sm:flex-row sm:justify-between sm:items-center font-[200] gap-6 py-8 px-6">
          ...
          <div className="flex gap-4 ">
            <a href="https://www.booking.com/hotel/it/clatur73.it.html">
              <TbBrandBooking className="cursor-pointer size-10" />
            </a>
          ...
          <div>
            <h6 className="">cel: (+39) 349 373 1968</h6>
            <h6 className="">email: carlitobr.sp@gmail.com</h6>
          </div>
          <h6>
