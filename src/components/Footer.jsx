...
export default function footer() {
  return (
    <>
      <img src={elli} alt="ellisse" className=" w-full h-[160px] z-10 -mt-40" />
      <footer className=" bg-grigio w-full sm:flex sm:justify-center sm:items-center">
        <div className=" flex flex-col max-w-4xl w-full sm:flex-row sm:justify-between sm:items-center font-[200] bg-grigio gap-6 py-8 px-6">
